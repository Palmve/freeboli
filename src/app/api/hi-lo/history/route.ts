 ...
 * - Provably fair de verificación instantánea: cada tirada guarda su server_seed revelada
 *   en metadata, así el enlace VER funciona al momento para todas las jugadas.
 */

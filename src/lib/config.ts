...
export const MAX_BET_POINTS = Number(process.env.NEXT_PUBLIC_MAX_BET_POINTS) || 10_000;
export const MAX_WIN_POINTS = Number(process.env.NEXT_PUBLIC_MAX_WIN_POINTS) || 100_000;
export const MAX_DAILY_WIN_POINTS = Number(process.env.NEXT_PUBLIC_MAX_DAILY_WIN_POINTS) || 1_000_000;
